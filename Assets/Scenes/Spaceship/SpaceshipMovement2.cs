...
{
    // Added Variables for 3D Asteroids Game
    [SerializeField] private float accelerationSensitivity = 1.0f;
    ...
    private void UpdateTrackIR()
    {
        if ( m_trackirClient != null )
        {
            ...
            // The X and Z axes were swapped because of imporper rotation
